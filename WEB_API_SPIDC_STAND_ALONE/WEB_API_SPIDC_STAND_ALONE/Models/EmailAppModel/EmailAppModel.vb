...
Public Class EmailAppModel
    ...
    'Email App Data Access Layer
    Private Shared EmailAppDataAccessLayer As New EmailAppDataAccessLayer

#Region "Variable EmailApp Web API"
...
#End Region
#Region "Property EmailApp Web API"
...
#End Region
    ...
    Public Shared Function _mPostValue(ByVal param As String, ByVal value As Object)
        Try
            ...
            Select Case param
                Case Spidc_Web_API_Config._mAppPostParamEmailApp
                    'Call The Data Access Layer
                    If EmailAppDataAccessLayer._mPostSendEmail(value) Then
                        _mStatus = EmailAppDataAccessLayer._mStatus
                        _mData = EmailAppDataAccessLayer._mData
                        _mMessage = EmailAppDataAccessLayer._mMessage
                        _mCode = EmailAppDataAccessLayer._mCode
                        Return True
                    Else
                        _mStatus = EmailAppDataAccessLayer._mStatus
                        _mData = EmailAppDataAccessLayer._mData
