    ...
    Public Shared Function _mGetValues(ByVal param As String) As Boolean
        Try
            ...
            Select Case param
                ...
                Case Spidc_Web_API_Config._mAppGetParam11Toims
                    CedulaDataAccessLayer._mStrSql = "SELECT MuniCityBrgyCode,MuniCityBrgyName FROM MuniCitySubBrgy"
            End Select
            ...
            Else
                ...
                Select Case param
                    Case Spidc_Web_API_Config._mAppPostParam1Tims
                        ...
                        _mStrSql1 = "INSERT INTO  CTC_Online_Application (Email, ControlNo, CTC_Type, ForYear, FirstName, MiddleName, LastName, BirthPlace, BirthDate, Barangay, [Address], Gender, CivilStatus, Citizenship, [Weight], Height, TIN, Profession, BasicCommunityTax, GrossReceipts, " & _
