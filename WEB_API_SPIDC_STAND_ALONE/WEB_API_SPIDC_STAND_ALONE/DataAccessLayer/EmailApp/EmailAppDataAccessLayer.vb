...
Public Class EmailAppDataAccessLayer
    'SPIDC Config
    Private Shared Spidc_Web_API_Config As New Spidc_Web_API_Config
#Region "Variable Data Access Layer Email App Web API"
...
#End Region
#Region "Property Data Access Layer Email App Web API"
...
#End Region
    ...
    Public Shared Function _mPostSendEmail(ByVal value As Object) As Boolean
        Try
            ...
            Dim toAddress As New MailAddress(_mJsonObject("RecipientEmail").ToString(), _mJsonObject("RecipientName").ToString())
